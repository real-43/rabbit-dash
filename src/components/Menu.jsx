      ...
      <div>
        <aside className="sidebar-mini main-sidebar  sidebar-dark-primary " style={{overflowX: 'hidden'}}>
          ...
          <a href="#" class="brand-link logo-switch logo-scale">
            <img src="rabbitcard-logo.jpg" alt="Rabbitcard Logo Small" class="brand-image-xl logo-xs" style={{top:"0", left: "0px", maxHeight: "55px", width: "60px", padding: "0px", transition:"10s"}} />
