                    ...
                    <div className="container">
                        <div className="row justify-content-center">
                            ...
                            <div className="input-group col-md-4 align-self-center my-2 mx-3" style={{ marginLeft: '25px', marginRight: '15px', background: 'white', height: '55px', borderRadius: '30px' }}>
                                <input className="form-control align-self-center search p17-5 search-box" style={{ backgroundImage: `url(${iconSearch})`, backgroundSize: '25px 25px', backgroundPosition: '0 9px', backgroundRepeat: 'no-repeat', padding: '0 0 0 35px', border: 0, marginRight: '2px' }} type="text" onChange={(e) => setSerial(e.target.value)} placeholder='Serial number...' />
