...
(function(global, factory) {
    ...
    var IFrame = /*#__PURE__*/ function() {
        ...
        _proto.createTab = function createTab(title, link, uniqueName, autoOpen) {
            ...
            var newNavItem = "<li className=\"nav-item\" role=\"presentation\"><a className=\"nav-link\" data-toggle=\"row\" id=\"" + navId + "\" href=\"#" + tabId + "\" role=\"tab\" aria-controls=\"" + tabId + "\" aria-selected=\"false\">" + title + "</a></li>";
    ...
    var SidebarSearch = /*#__PURE__*/ function() {
        ...
        _proto._renderItem = function _renderItem(name, link, path) {
            ...
            if (this.options.highlightName || this.options.highlightPath) {
                ...
                if (this.options.highlightName) {
                    name = name.replace(regExp, function(str) {
                        return "<b className=\"" + _this4.options.highlightClass + "\">" + str + "</b>";
                    });
                }
            ...
            return "<a href=\"" + link + "\" className=\"list-group-item\">\n        <div className=\"search-title\">\n          " + name + "\n        </div>\n        <div className=\"search-path\">\n          " + path + "\n        </div>\n      </a>";
        };
