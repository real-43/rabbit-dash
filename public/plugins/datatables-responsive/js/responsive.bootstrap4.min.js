...
(function(c) {
    ...
    var a = c.fn.dataTable,
        ...
        g = b.modal,
        e = c('<div className="modal fade dtr-bs-modal" role="dialog"><div className="modal-dialog" role="document"><div className="modal-content"><div className="modal-header"><button type="button" className="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><div className="modal-body"/></div></div></div>');
    b.modal = function(a) {
            ...
            if (c.fn.modal) {
                if (!d) {
                    if (a && a.header) {
                        ...
                        d.empty().append('<h4 className="modal-title">' + a.header(b) + "</h4>").append(h)
                    }
