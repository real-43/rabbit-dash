/*! For license information please see summernote.min.js.LICENSE.txt */ ! function(t, e) {
    ...
    return function(t) {
        ...
        return n.m = t, n.c = e, n.d = function(t, e, o) { n.o(t, e) || Object.defineProperty(t, e, { enumerable: !0, get: o }) }, n.r = function(t) { "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(t, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(t, "__esModule", { value: !0 }) }, n.t = function(t, e) {
            ...
            return o
        }, n.n = function(t) { var e = t && t.__esModule ? function() { return t.default } : function() { return t }; return n.d(e, "a", e), e }, n.o = function(t, e) { return Object.prototype.hasOwnProperty.call(t, e) }, n.p = "", n(n.s = 52)
    }({
        ...
        3: function(t, e, n) {
            ...
            var pt = {
                ...
                isInline: A,
                isBlock: g.not(A),
                isBodyInline: function(t) { return A(t) && !V(t, $) },
                isBody: O,
                isParaInline: function(t) { return A(t) && !!V(t, $) },
                isPre: N,
                isList: F,
                isTable: R,
                isData: L,
        ...
        52: function(t, e, n) {
            ...
            var s = r.a.create('<div className="note-editor note-frame panel panel-default"/>'),
                l = r.a.create('<div className="panel-heading note-toolbar" role="toolbar"/>'),
                c = r.a.create('<div className="note-editing-area"/>'),
                u = r.a.create('<textarea className="note-codable" aria-multiline="true"/>'),
                d = r.a.create('<div className="note-editable" contentEditable="true" role="textbox" aria-multiline="true"/>'),
                ...
                v = r.a.create('<ul className="note-dropdown-menu dropdown-menu">', (function(t, e) {
                ...
                g = function(t, e) { return t + " " + C(e.icons.caret, "span") },
                b = r.a.create('<ul className="note-dropdown-menu dropdown-menu note-check">', (function(t, e) {
                    var n = Array.isArray(e.items) ? e.items.map((function(t) {
                        var n = "string" == typeof t ? t : t.value || "",
                            o = e.template ? e.template(t) : t;
                ...
                y = r.a.create('<div className="modal note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>', (function(t, e) { e.fade && t.addClass("fade"), t.attr({ "aria-label": e.title }), t.html(['<div className="modal-dialog">', '<div className="modal-content">', e.title ? '<div className="modal-header"><button type="button" className="close" data-dismiss="modal" aria-label="Close" aria-hidden="true">&times;</button><h4 className="modal-title">' + e.title + "</h4></div>" : "", '<div className="modal-body">' + e.body + "</div>", e.footer ? '<div className="modal-footer">' + e.footer + "</div>" : "", "</div>", "</div>"].join("")) })),
                ...
                w = r.a.create('<div className="checkbox"></div>', (function(t, e) { t.html(["<label" + (e.id ? ' for="note-' + e.id + '"' : "") + ">", '<input type="checkbox"' + (e.id ? ' id="note-' + e.id + '"' : ""), e.checked ? " checked" : "", ' aria-checked="' + (e.checked ? "true" : "false") + '"/>', e.text ? e.text : "", "</label>"].join("")) })),
                ...
                x = function(t) {
                    return {
                        ...
                        button: function(e, n) { return r.a.create('<button type="button" className="note-btn btn btn-default btn-sm" tabindex="-1">', (function(e, n) { n && n.tooltip && e.attr({ title: n.tooltip, "aria-label": n.tooltip }).tooltip({ container: n.container || t.container, trigger: "hover", placement: "bottom" }).on("click", (function(t) { i()(t.currentTarget).tooltip("hide") })), n && n.codeviewButton && e.addClass("note-codeview-keep") }))(e, n) },
