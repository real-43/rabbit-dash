    ...
    return /******/ (function(modules) { // webpackBootstrap
        ...
        ({
            ...
            /***/
                ...
                var editor = renderer["a" /* default */ ].create('<div className="note-editor note-frame card"/>');
                var toolbar = renderer["a" /* default */ ].create('<div className="note-toolbar card-header" role="toolbar"/>');
                ...
                var editable = renderer["a" /* default */ ].create('<div className="note-editable card-block" contentEditable="true" role="textbox" aria-multiline="true"/>');
                ...
                var dropdown = renderer["a" /* default */ ].create('<div className="note-dropdown-menu dropdown-menu" role="list">', function($node, options) {
                    var markup = Array.isArray(options.items) ? options.items.map(function(item) {
                        ...
                        return '<a className="dropdown-item" href="#" ' + (dataValue + dataOption) + ' role="listitem" aria-label="' + value + '">' + content + '</a>';
                    }).join('') : options.items;
                ...
                var dropdownCheck = renderer["a" /* default */ ].create('<div className="note-dropdown-menu dropdown-menu note-check" role="list">', function($node, options) {
                    var markup = Array.isArray(options.items) ? options.items.map(function(item) {
                        var value = typeof item === 'string' ? item : item.value || '';
                        var content = options.template ? options.template(item) : item;
                        return '<a className="dropdown-item" href="#" data-value="' + value + '" role="listitem" aria-label="' + item + '">' + icon(options.checkClassName) + ' ' + content + '</a>';
                    }).join('') : options.items;
                    $node.html(markup).attr({
                        'aria-label': options.title
                    });
                ...
                var dialog = renderer["a" /* default */ ].create('<div className="modal note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>', function($node, options) {
                    ...
                    $node.html(['<div className="modal-dialog">', '<div className="modal-content">', options.title ? '<div className="modal-header">' + '<h4 className="modal-title">' + options.title + '</h4>' + '<button type="button" className="close" data-dismiss="modal" aria-label="Close" aria-hidden="true">&times;</button>' + '</div>' : '', '<div className="modal-body">' + options.body + '</div>', options.footer ? '<div className="modal-footer">' + options.footer + '</div>' : '', '</div>', '</div>'].join(''));
                });
                ...
                var ui_checkbox = renderer["a" /* default */ ].create('<div className="form-check"></div>', function($node, options) {
                    $node.html(['<label className="form-check-label"' + (options.id ? ' for="note-' + options.id + '"' : '') + '>', '<input type="checkbox" className="form-check-input"' + (options.id ? ' id="note-' + options.id + '"' : ''), options.checked ? ' checked' : '', ' aria-label="' + (options.text ? options.text : '') + '"', ' aria-checked="' + (options.checked ? 'true' : 'false') + '"/>', ' ' + (options.text ? options.text : '') + '</label>'].join(''));
                });
                ...
                var ui_ui = function ui(editorOptions) {
                    return {
                        ...
                        button: function button($node, options) {
                            return renderer["a" /* default */ ].create('<button type="button" className="note-btn btn btn-light btn-sm" tabindex="-1">', function($node, options) {
