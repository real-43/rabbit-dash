/*! For license information please see summernote-bs4.min.js.LICENSE.txt */ ! function(t, e) {
    ...
    return function(t) {
        ...
        3: function(t, e, n) {
            ...
            var C = {
                    ...
                    clusterBy: function(t, e) {
                        return t.length ? k(t).reduce((function(t, n) { var o = y(t); return e(y(o), n) ? o[o.length] = n : t[t.length] = [n], t }), [
                            [b(t)]
                        ]) : []
                    },
            ...
            function I(t) { return t && /^BR|^IMG|^HR|^IFRAME|^BUTTON|^INPUT|^AUDIO|^VIDEO|^EMBED/.test(t.nodeName.toUpperCase()) }

            function $(t) { return !S(t) && (t && /^DIV|^P|^LI|^H[1-7]/.test(t.nodeName.toUpperCase())) }
            var N = T("PRE"),
                P = T("LI");
            var R = T("TABLE"),
                L = T("DATA");

            function A(t) { return !(B(t) || F(t) || D(t) || $(t) || R(t) || z(t) || L(t)) }
            ...
            function B(t) { return H(t) || z(t) || S(t) }
            var M = T("A");
            var O = T("BODY");
            ...
            function K(t) { I(t) || U(t) || (t.innerHTML = j) }
            ...
            function V(t, e) { e = e || g.fail; var n = []; return q(t, (function(t) { return S(t) || n.push(t), e(t) })), n }
            ...
            function ct(t, e, n) { var o = V(e.node, g.eq(t)); return o.length ? 1 === o.length ? lt(e, n) : o.reduce((function(t, o) { return t === e.node && (t = lt(e, n)), lt({ node: o, offset: t ? et(t) : U(o) }, n) })) : null }
            ...
            var pt = {
                ...
                isVoid: I,
                isPara: $,
                isPurePara: function(t) { return $(t) && !P(t) },
                isHeading: function(t) { return t && /^H[1-7]/.test(t.nodeName.toUpperCase()) },
                isInline: A,
                isBlock: g.not(A),
                isBodyInline: function(t) { return A(t) && !q(t, $) },
                isBody: O,
                isParaInline: function(t) { return A(t) && !!q(t, $) },
                isPre: N,
                isList: F,
                isTable: R,
                isData: L,
                ...
                listAncestor: V,
                lastAncestor: function(t, e) { var n = V(t); return C.last(n.filter(e)) },
                listNext: _,
                ...
                position: et,
                hasChildren: nt,
                makeOffsetPath: function(t, e) { return V(e, g.eq(t)).map(et).reverse() },
            ...
            var kt = function() {
                    ...
                    var e, n, o;
                    return e = t, (n = [{ key: "nativeRange", value: function() { if (m.isW3CRangeSupport) { var t = document.createRange(); return t.setStart(this.sc, this.so), t.setEnd(this.ec, this.eo), t } var e = yt({ node: this.sc, offset: this.so }); return e.setEndPoint("EndToEnd", yt({ node: this.ec, offset: this.eo })), e } }, { key: "getPoints", value: function() { return { sc: this.sc, so: this.so, ec: this.ec, eo: this.eo } } }, { key: "getStartPoint", value: function() { return { node: this.sc, offset: this.so } } }, { key: "getEndPoint", value: function() { return { node: this.ec, offset: this.eo } } }, {
                        key: "select",
                        value: function() {
                ...
                wt = {
                    create: function(t, e, n, o) { if (4 === arguments.length) return new kt(t, e, n, o); if (2 === arguments.length) return new kt(t, e, n = t, o = e); var i = this.createFromSelection(); if (!i && 1 === arguments.length) { var r = arguments[0]; return pt.isEditable(r) && (r = r.lastChild), this.createFromBodyElement(r, pt.emptyPara === arguments[0].innerHTML) } return i },
            ...
            var Rt = function() {
                function t(e) {! function(t, e) { if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function") }(this, t), this.bullet = new Nt, this.options = e.options }
                var e, n, o;
                return e = t, (n = [{
                    key: "insertTab",
                    value: function(t, e) {
                ...
                return e = t, (n = [{
                    ...
                    value: function(t, e) {
                        ...
                        if ("" !== n) {
                            ...
                            var a = i.a.now();
                            this.$editor.find(".note-status-output").html('<div id="note-status-output-' + a + '" className="alert alert-info">' + this.lang.output.noSelection + "</div>"), setTimeout((function() { i()("#note-status-output-" + a).remove() }), 5e3)
                        }
                    }
                }, {
                    key: "unlink",
            ...
            var Vt = function() {
                ...
                }, { key: "destroy", value: function() { this.$statusbar.off(), this.$statusbar.addClass("locked") } }]) && qt(e.prototype, n), o && qt(e, o), t
            }();
            ...
            var re = function() {
                ...
                return e = t, (n = [{ key: "shouldInitialize", value: function() { return !!this.options.placeholder } }, {
                    ...
                    value: function() {
                        var t = this;
                        this.$placeholder = i()('<div className="note-placeholder">'), this.$placeholder.on("click", (function() { t.context.invoke("focus") })).html(this.options.placeholder).prependTo(this.$editingArea), this.update()
                    }
                        ...
                        this.context.memo("button.style", (function() {
                            return t.ui.buttonGroup([t.button({ className: "dropdown-toggle", contents: t.ui.dropdownButtonContents(t.ui.icon(t.options.icons.magic), t.options), tooltip: t.lang.style.style, data: { toggle: "dropdown" } }), t.ui.dropdown({
                                ...
                                template: function(e) {
                                    ...
                                    var n = e.tag,
                                        o = e.title;
                                    return "<" + n + (e.style ? ' style="' + e.style + '" ' : "") + (e.className ? ' className="' + e.className + '"' : "") + ">" + o + "</" + n + ">"
                                },
            ...
            var we = function() {
                ...
                return e = t, (n = [{
                    ...
                    value: function() {
                        var t = this.options.dialogsInBody ? this.$body : this.options.container,
                            e = ['<div className="form-group note-form-group row-fluid">', '<label for="note-dialog-video-url-'.concat(this.options.id, '" className="note-form-label">').concat(this.lang.video.url, ' <small className="text-muted">').concat(this.lang.video.providers, "</small></label>"), '<input id="note-dialog-video-url-'.concat(this.options.id, '" className="note-video-url form-control note-form-control note-input" type="text"/>'), "</div>"].join(""),
                            n = '<input type="button" href="#" className="'.concat("btn btn-primary note-btn note-btn-primary note-video-btn", '" value="').concat(this.lang.video.insert, '" disabled>');
            ...
            var xe = function() {
                ...
                return e = t, (n = [{
                    ...
                    value: function() {
                        var t = this.options.dialogsInBody ? this.$body : this.options.container,
                            e = ['<p className="text-center">', '<a href="http://summernote.org/" target="_blank">Summernote 0.8.18</a> · ', '<a href="https://github.com/summernote/summernote" target="_blank">Project</a> · ', '<a href="https://github.com/summernote/summernote/issues" target="_blank">Issues</a>', "</p>"].join("");
                    ...
                    value: function() {
                        ...
                        return Object.keys(e).map((function(n) {
                            var o = e[n],
                                r = i()('<div><div className="help-list-item"></div></div>');
            ...
            var Ie = function() {
                ...
                return e = t, (n = [{ key: "shouldInitialize", value: function() { return this.hints.length > 0 } }, {
                ...
                }, { key: "createItemTemplates", value: function(t, e) { var n = this.hints[t]; return e.map((function(e) { var o = i()('<div className="note-hint-item"/>'); return o.append(n.template ? n.template(e) : e + ""), o.data({ index: t, item: e }), o })) } }, { key: "handleKeydown", value: function(t) { this.$popover.is(":visible") && (t.keyCode === xt.code.ENTER ? (t.preventDefault(), this.replace()) : t.keyCode === xt.code.UP ? (t.preventDefault(), this.moveUp()) : t.keyCode === xt.code.DOWN && (t.preventDefault(), this.moveDown())) } }, {
                    key: "searchKeyword",
                    value: function(t, e, n) {
                        var o = this.hints[t];
                    ...
                    value: function(t, e) {
                        var n = this,
                            o = i()('<div className="note-hint-group note-hint-group-' + t + '"></div>');
            ...
            i.a.summernote = i.a.extend(i.a.summernote, {
                ...
                options: {
                    ...
                    editing: !0,
                    modules: { editor: Ht, clipboard: Bt, dropzone: Ot, codeview: Kt, statusbar: Vt, fullscreen: Gt, handle: Zt, hintPopover: Ie, autoLink: Jt, autoSync: ee, autoReplace: oe, placeholder: re, buttons: se, toolbar: ce, linkDialog: de, linkPopover: fe, imageDialog: me, imagePopover: ge, tablePopover: ye, videoDialog: we, helpDialog: xe, airPopover: Te },
                    buttons: {},
                    lang: "en-US",
                    followingToolbar: !1,
                    toolbarPosition: "top",
        ...
        53: function(t, e, n) {
            ...
            var s = r.a.create('<div className="note-editor note-frame card"/>'),
                l = r.a.create('<div className="note-toolbar card-header" role="toolbar"/>'),
                c = r.a.create('<div className="note-editing-area"/>'),
                u = r.a.create('<textarea className="note-codable" aria-multiline="true"/>'),
                d = r.a.create('<div className="note-editable card-block" contentEditable="true" role="textbox" aria-multiline="true"/>'),
                h = r.a.create(['<output className="note-status-output" role="status" aria-live="polite"></output>', '<div className="note-statusbar" role="status">', '<div className="note-resizebar" aria-label="Resize">', '<div className="note-icon-bar"></div>', '<div className="note-icon-bar"></div>', '<div className="note-icon-bar"></div>', "</div>", "</div>"].join("")),
                f = r.a.create('<div className="note-editor note-airframe"/>'),
                p = r.a.create(['<div className="note-editable" contentEditable="true" role="textbox" aria-multiline="true"></div>', '<output className="note-status-output" role="status" aria-live="polite"></output>'].join("")),
                m = r.a.create('<div className="note-btn-group btn-group">'),
                v = r.a.create('<div className="note-dropdown-menu dropdown-menu" role="list">', (function(t, e) {
                    var n = Array.isArray(e.items) ? e.items.map((function(t) {
                        ...
                        return '<a className="dropdown-item" href="#" ' + ('data-value="' + n + '"' + (void 0 !== i ? ' data-option="' + i + '"' : "")) + ' role="listitem" aria-label="' + n + '">' + o + "</a>"
                    })).join("") : e.items;
                    t.html(n).attr({ "aria-label": e.title }), e && e.codeviewKeepButton && t.addClass("note-codeview-keep")
                })),
                g = function(t) { return t },
                b = r.a.create('<div className="note-dropdown-menu dropdown-menu note-check" role="list">', (function(t, e) {
                    var n = Array.isArray(e.items) ? e.items.map((function(t) {
                        var n = "string" == typeof t ? t : t.value || "",
                            o = e.template ? e.template(t) : t;
                        return '<a className="dropdown-item" href="#" data-value="' + n + '" role="listitem" aria-label="' + t + '">' + C(e.checkClassName) + " " + o + "</a>"
                    })).join("") : e.items;
                    t.html(n).attr({ "aria-label": e.title }), e && e.codeviewKeepButton && t.addClass("note-codeview-keep")
                })),
                y = r.a.create('<div className="modal note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>', (function(t, e) { e.fade && t.addClass("fade"), t.attr({ "aria-label": e.title }), t.html(['<div className="modal-dialog">', '<div className="modal-content">', e.title ? '<div className="modal-header"><h4 className="modal-title">' + e.title + '</h4><button type="button" className="close" data-dismiss="modal" aria-label="Close" aria-hidden="true">&times;</button></div>' : "", '<div className="modal-body">' + e.body + "</div>", e.footer ? '<div className="modal-footer">' + e.footer + "</div>" : "", "</div>", "</div>"].join("")) })),
                k = r.a.create(['<div className="note-popover popover in">', '<div className="arrow"></div>', '<div className="popover-content note-children-container"></div>', "</div>"].join(""), (function(t, e) {
                    var n = void 0 !== e.direction ? e.direction : "bottom";
                    t.addClass(n), e.hideArrow && t.find(".arrow").hide()
                })),
                w = r.a.create('<div className="form-check"></div>', (function(t, e) { t.html(['<label className="form-check-label"' + (e.id ? ' for="note-' + e.id + '"' : "") + ">", '<input type="checkbox" className="form-check-input"' + (e.id ? ' id="note-' + e.id + '"' : ""), e.checked ? " checked" : "", ' aria-label="' + (e.text ? e.text : "") + '"', ' aria-checked="' + (e.checked ? "true" : "false") + '"/>', " " + (e.text ? e.text : "") + "</label>"].join("")) })),
                C = function(t, e) { return "<" + (e = e || "i") + ' className="' + t + '"></' + e + ">" },
                x = function(t) {
                    return {
                        editor: s,
                        toolbar: l,
