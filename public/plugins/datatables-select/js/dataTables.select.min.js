...
(function(e) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function(i) { return e(i, window, document) }) : "object" === typeof exports ? module.exports = function(i, j) { i || (i = window); if (!j || !j.fn.dataTable) j = require("datatables.net")(i, j).$; return e(j, i, i.document) } : e(jQuery, window, document) })(function(e, i, j, h) {
    ...
    function z(a) {
        ...
        if (c._select.info && c.aanFeatures.i && "api" !== a.select.style()) {
            var b = a.rows({ selected: !0 }).flatten().length,
                ...
                l = function(b, c, d) { b.append(e('<span className="select-item"/>').append(a.i18n("select." + c + "s", { _: "%d " + c + "s selected", "0": "", 1: "1 " + c + " selected" }, d))) };
            e.each(c.aanFeatures.i, function(c, a) {
                var a = e(a),
                    g = e('<span className="select-info"/>');
                l(g, "row", b);
                l(g, "column", d);
                l(g, "cell", f);
    ...
    m("select.selector()",
        function(a) {
            return a === h ? this.context[0]._select.selector : this.iterator("table", function(c) {
                ...
                "api" !== c._select.style && y(new g.Api(c))
            })
        });
    n("rows().select()", "row().select()", function(a) {
        ...
        this.iterator("table", function(b, a) { k(c, "select", ["row", c[a]], !0) });
        return this
    });
    n("columns().select()", "column().select()",
        function(a) {
            ...
            this.iterator("table", function(b, a) { k(c, "select", ["column", c[a]], !0) });
            return this
        });
    ...
    n("rows().deselect()", "row().deselect()", function() {
        ...
        this.iterator("table", function(c, b) { k(a, "deselect", ["row", a[b]], !0) });
        return this
    });
    ...
    n("cells().deselect()", "cell().deselect()", function() {
        ...
        this.iterator("table", function(c, b) { k(a, "deselect", ["cell", a[b]], !0) });
        return this
    });
    var t = 0;
