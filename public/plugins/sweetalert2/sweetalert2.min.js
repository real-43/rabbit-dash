! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = t || self).Sweetalert2 = e() }(this, function() {
    ...
    var gt, vt = function(t, e) { ot(t, e, !0) },
        ...
        Ct = '\n <div aria-labelledby="'.concat($.title, '" aria-describedby="').concat($.content, '" className="').concat($.popup, '" tabindex="-1">\n   <div className="').concat($.header, '">\n     <ul className="').concat($["progress-steps"], '"></ul>\n     <div className="').concat($.icon, " ").concat(X.error, '"></div>\n     <div className="').concat($.icon, " ").concat(X.question, '"></div>\n     <div className="').concat($.icon, " ").concat(X.warning, '"></div>\n     <div className="').concat($.icon, " ").concat(X.info, '"></div>\n     <div className="').concat($.icon, " ").concat(X.success, '"></div>\n     <img className="').concat($.image, '" />\n     <h2 className="').concat($.title, '" id="').concat($.title, '"></h2>\n     <button type="button" className="').concat($.close, '"></button>\n   </div>\n   <div className="').concat($.content, '">\n     <div id="').concat($.content, '" className="').concat($["html-container"], '"></div>\n     <input className="').concat($.input, '" />\n     <input type="file" className="').concat($.file, '" />\n     <div className="').concat($.range, '">\n       <input type="range" />\n       <output></output>\n     </div>\n     <select className="').concat($.select, '"></select>\n     <div className="').concat($.radio, '"></div>\n     <label for="').concat($.checkbox, '" className="').concat($.checkbox, '">\n       <input type="checkbox" />\n       <span className="').concat($.label, '"></span>\n     </label>\n     <textarea className="').concat($.textarea, '"></textarea>\n     <div className="').concat($["validation-message"], '" id="').concat($["validation-message"], '"></div>\n   </div>\n   <div className="').concat($.actions, '">\n     <div className="').concat($.loader, '"></div>\n     <button type="button" className="').concat($.confirm, '"></button>\n     <button type="button" className="').concat($.deny, '"></button>\n     <button type="button" className="').concat($.cancel, '"></button>\n   </div>\n   <div className="').concat($.footer, '"></div>\n   <div className="').concat($["timer-progress-bar-container"], '">\n     <div className="').concat($["timer-progress-bar"], '"></div>\n   </div>\n </div>\n').replace(/(^|\n)\s*/g, ""),
        kt = function(t) {
    ...
    var Tt = { promise: new WeakMap, innerParams: new WeakMap, domCache: new WeakMap },
        ...
        Mt = {};
    Mt.text = Mt.email = Mt.password = Mt.number = Mt.tel = Mt.url = function(t, e) { return "string" == typeof e.inputValue || "number" == typeof e.inputValue ? t.value = e.inputValue : w(e.inputValue) || W('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(r(e.inputValue), '"')), Ot(t, t, e), St(t, e), t.type = e.input, t }, Mt.file = function(t, e) { return Ot(t, t, e), St(t, e), t }, Mt.range = function(t, e) {
    ...
    var Ft = function() { for (var t = n(), e = 0; e < t.length; e++) at(t[e]) },
        ...
        Zt = function(t) { return '<div className="'.concat($["icon-content"], '">').concat(t, "</div>") },
        Qt = [],
    ...
    var Ee = function(t, e, n) { null !== e && "function" == typeof e ? e(t) : null !== n && "function" == typeof n && n(t) },
        Se = function(t, e, n, o) { ee.swalCloseEventFinishedCallback = Ae.bind(null, t, n, G(), o), e.addEventListener(Bt, function(t) { t.target === e && (ee.swalCloseEventFinishedCallback(), delete ee.swalCloseEventFinishedCallback) }) },
    ...
    var Re = ["swal-title", "swal-html", "swal-footer"],
        ...
        un = function(e, t, n) { t.preDeny ? Promise.resolve().then(function() { return y(t.preDeny(n, t.validationMessage)) }).then(function(t) {!1 === t ? e.hideLoading() : e.closePopup({ isDenied: !0, value: void 0 === t ? n : t }) }) : e.closePopup({ isDenied: !0, value: n }) },
    ...
    s(In.prototype, J), s(In, pe), Object.keys(J).forEach(function(t) { In[t] = function() { if (Dn) return Dn[t].apply(Dn, arguments) } }), In.DismissReason = Q, In.version = "10.12.6";
    var Mn = In;
