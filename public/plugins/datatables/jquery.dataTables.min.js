...
(function(h) {
    ...
    function rb(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            g = '<input type="search" className="' + b.sFilterInput + '"/>',
            j = d.sSearch,
    ...
    function ma(a) {
        ...
        if (a.scrollBarVis !== L && a.scrollBarVis !== k) a.scrollBarVis = L, aa(a);
            ...
            I(function(a, b) {
                a.innerHTML = '<div className="dataTables_sizing">' + y[b] + "</div>";
            ...
            t && I(function(a, b) {
                a.innerHTML = '<div className="dataTables_sizing">' + z[b] + "</div>";
                a.childNodes[0].style.height = "0";
                a.childNodes[0].style.overflow = "hidden";
                a.style.width = x[b]
            }, R);
                    ...
                    r = function(b, d) {
                        ...
                        for (t = d.length; k < t; k++) {
                            ...
                            if (Array.isArray(u)) {
                                ...
                                switch (u) {
                                    case "ellipsis":
                                        b.append('<span className="ellipsis">&#x2026;</span>');
                                        break;
                                    case "first":
                                        l = j.sFirst;
                                        if (e === 0) {
