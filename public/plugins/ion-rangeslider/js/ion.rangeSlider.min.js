...
! function(i) { "undefined" != typeof jQuery && jQuery || "function" != typeof define || !define.amd ? "undefined" != typeof jQuery && jQuery || "object" != typeof exports ? i(jQuery, document, window, navigator) : i(require("jquery"), document, window, navigator) : define(["jquery"], function(t) { return i(t, document, window, navigator) }) }(function(a, c, l, t, _) {
    ...
    h.prototype = {
            ...
            appendDisableMask: function() { this.$cache.cont.append('<span className="irs-disable-mask"></span>'), this.$cache.cont.addClass("irs-disabled") },
            ...
            appendGrid: function() {
                if (this.options.grid) {
                    ...
                    for (this.calcGridMargin(), r.grid_snap && (a = n / r.step), 50 < a && (a = 50), s = this.toFixed(100 / a), 4 < a && (l = 3), 7 < a && (l = 2), 14 < a && (l = 1), 28 < a && (l = 0), t = 0; t < a + 1; t++) {
                        for (o = l, 100 < (c = this.toFixed(s * t)) && (c = 100), e = ((this.coords.big[t] = c) - s * (t - 1)) / (o + 1), i = 1; i <= o && 0 !== c; i++) _ += '<span className="irs-grid-pol small" style="left: ' + this.toFixed(c - e * i) + '%"></span>';
                        _ += '<span className="irs-grid-pol" style="left: ' + c + '%"></span>', h = this.convertToValue(c), _ += '<span className="irs-grid-text js-grid-text-' + t + '" style="left: ' + c + '%">' + (h = r.values.length ? r.p_values[h] : this._prettify(h)) + "</span>"
                    }
