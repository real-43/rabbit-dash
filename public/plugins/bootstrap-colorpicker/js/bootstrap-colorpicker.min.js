    ...
    return function(modules) {
        ...
        var Preview = function(_Extension) {
            ...
            function Preview(colorpicker) {
                ...
                var _this = _possibleConstructorReturn(this, (Preview.__proto__ || Object.getPrototypeOf(Preview)).call(this, colorpicker, _jquery2.default.extend(true, {}, { template: '<div className="colorpicker-bar colorpicker-preview"><div /></div>', showText: true, format: colorpicker.format }, options)));
        ...
        var defaults = { barTemplate: '<div className="colorpicker-bar colorpicker-swatches">\n                    <div className="colorpicker-swatches--inner"></div>\n                </div>', swatchTemplate: '<i className="colorpicker-swatch"><i className="colorpicker-swatch--inner"></i></i>' };
